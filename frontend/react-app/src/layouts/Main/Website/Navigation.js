...
import { MenuIcon, XIcon, Button } from '@heroicons/react/outline'
...
function Navigation() {
    ...
    return (
        <div className="relative z-10 lg:w-full p-3">
            <Popover>
                <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                    <nav className="relative flex items-center justify-between sm:h-10 lg:justify-between" aria-label="Global">
                        ...
                        <div className="flex items-center justify-between w-full md:w-auto">
                            <NavLink to="/">
                                <img src={MagicLeafLogo} style={{ height: 70 }} />
                            </NavLink>
                ...
                >
                    <div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                        <div className="px-5 pt-4 flex items-center justify-between">
                            <div>
                                <img src={MagicLeafLogo} style={{ height: 90 }} />
                            </div>
                            <div className="-mr-2">
