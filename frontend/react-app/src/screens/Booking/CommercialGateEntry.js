...
const CommercialGateDescription = ({details, pass, timeLeft}) => {
    ...
    return (
        ...
        >
            ...
            <Descriptions.Item label="Previous status">{details.status}</Descriptions.Item>
            <Descriptions.Item label="New status">Checked-in</Descriptions.Item>
        </Descriptions>
...
function Page(props) {
    ...
    return (
        <InterfaceLayout {...props}>
            <Typography.Title level={2}><img src={CamayaLogo} style={{width: 180, verticalAlign:'text-bottom'}} />Commercial Gate Entry</Typography.Title>
                ...
                <Col xl={14}>
                    ...
                    { scanAndCheckIsLoading && <>Fetching details...</> }
                    {
                        ...
                        <div>
                            ...
                            <Typography.Title level={3} className="text-success">Welcome to Camaya Coast!</Typography.Title>
                            <div className="mb-2">Here are your details.</div>
                            {
                                details.pass && <CommercialGateDescription pass={details.pass} details={details.data} timeLeft={timeLeft} />
                            }
                        </div>
                    }
